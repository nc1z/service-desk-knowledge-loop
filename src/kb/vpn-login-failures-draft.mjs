export const vpnLoginFailuresKbPath = "kb/vpn-login-failures.md";

export const vpnLoginFailuresKbTemplate = [
  "Agent Summary",
  "Symptoms",
  "Likely Cause",
  "Agent Steps",
...
export function buildVpnLoginFailuresKbDraft() {
  return `# KB Draft: VPN Login Fails After MFA Approval
